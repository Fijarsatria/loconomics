...
|---|---|---|
| [jebakan.md](jebakan.md) | 268 kesalahan yang benar-benar terjadi di repo ini, sebabnya, dan perbaikannya | **Sebelum menyentuh sebuah bagian** — `grep` nama berkasnya di sana. Sebagian besar jebakannya gagal DIAM |
