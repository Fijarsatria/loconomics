...
**466 asersi otomatis lolos** di sembilan berkas uji — 273 di `backend/tests/` (37+42+44+36+114), 193 di `pipeline/` (130+34+14+15). Ditambah **29 asersi audit peramban** di `frontend/scripts/audit-prd.mjs`, yang menuntut backend dan frontend hidup sehingga sengaja TIDAK dijumlahkan ke angka di atas.
