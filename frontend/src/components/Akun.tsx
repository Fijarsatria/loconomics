...
const K_BAYAR = {
  id: {
    ...
    alasanRayakan:
      'Akun gratis sudah bisa melihat peta, skor, dan zonasi. Premium yang membuka Loconomics AI, 43 variabel, komparasi, pemantauan, dan Laporan Kelayakan.',
    ...
    akunGratisSiap: 'Akun gratis Anda aktif. Peta, skor, dan zonasi sudah bisa dipakai.',
  ...
  en: {
    ...
    alasanRayakan:
      'A free account already sees the map, the scores, and the zoning. Premium is what opens Loconomics AI, the 43 variables, comparison, watching, and the Feasibility Report.',
    ...
    akunGratisSiap: 'Your free account is active. The map, scores, and zoning are ready.',
...
export function TombolAkun({
  ...
  // Efek warna tombol sign up khusus tombol DI PETA (permintaan pemilik repo 21
  // Sep 2026). Di halaman gerbang ia justru rancu: tombol akun pelanggan akan
  // terlihat persis seperti ajakan mendaftar yang ada di sebelahnya.
  const pendarSignUp = premium && varian !== 'gerbang'
        ...
        className={
          bulat
            ? `grid h-10 w-10 cursor-pointer place-items-center rounded-full text-[13px] font-bold transition-all duration-300 ease-jelly hover:scale-[1.08] ${
                // Pelanggan di peta memakai efek tombol sign up (`.g-catalyst`);
                // di gerbang pendar teal yang lama. Label "Premium" tidak lagi
                // muat di bar bawah, jadi warnanya yang membawa statusnya.
                pendarSignUp
                  ? 'g-catalyst'
                  : premium
